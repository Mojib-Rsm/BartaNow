 ...
 *
 * - summarizeArticle - A function that generates a summary for a given article.
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following article in a concise and engaging manner, suitable for use as a preview.  Keep the summary to under 200 characters.\n\n{{{articleContent}}}`, 
});
