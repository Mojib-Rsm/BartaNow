...
const pages: Page[] = [
    ...
    },
    {
        ...
        slug: 'privacy-policy',
        content: `
            <p>আপনার গোপনীয়তা আমাদের কাছে গুরুত্বপূর্ণ। এই নীতিটি ব্যাখ্যা করে যে আমরা আপনার কাছ থেকে কোন তথ্য সংগ্রহ করি এবং কীভাবে তা ব্যবহার করি।</p>
            <p>আমরা আপনার নাম, ইমেইল এবং অন্যান্য তথ্য সংগ্রহ করতে পারি যখন আপনি আমাদের নিউজলেটারে সাবস্ক্রাইব করেন বা মন্তব্য করেন। এই তথ্য শুধুমাত্র আপনাকে উন্নত সেবা প্রদানের জন্য ব্যবহৃত হয়।</p>
        `,
        publishedAt: '2024-01-01T10:00:00Z',
    ...
    },
    {
        ...
        slug: 'terms-of-use',
        content: `
            <p>বার্তা নাও ওয়েবসাইট ব্যবহার করার মাধ্যমে, আপনি আমাদের ব্যবহারের শর্তাবলী মেনে নিচ্ছেন।</p>
            <p>এই ওয়েবসাইটের সকল কন্টেন্ট বার্তা নাও-এর সম্পত্তি। অনুমতি ছাড়া কোনো কন্টেন্ট বাণিজ্যিক উদ্দেশ্যে ব্যবহার করা যাবে না।</p>
        `,
        publishedAt: '2024-01-01T10:00:00Z',
        lastUpdatedAt: '2024-07-29T10:00:00Z',
    }
