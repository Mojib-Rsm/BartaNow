...
import type { Article, Author, Poll, MemeNews, User, Comment, Media, Notification, Page, MenuItem, Subscriber, RssFeed } from './types';
...
const articlesData: Omit<Article, 'slug' | 'status'>[] = [
  {
    ...
    category: 'খেলা',
    content: `
      <p>এশিয়া কাপের উদ্বোধনী ম্যাচে বাংলাদেশ ক্রিকেট দল এক অসাধারণ পারফরম্যান্স দেখিয়ে প্রতিপক্ষকে হারিয়েছে। অধিনায়কের শতক এবং বোলারদের নিয়ন্ত্রিত বোলিং দলের জয় নিশ্চিত করে।</p>
      <p>এই জয়ের ফলে দলের মনোবল অনেকটাই বেড়ে গেছে এবং সমর্থকরা আশাবাদী যে টুর্নামেন্টে বাংলাদেশ ভালো কিছু করবে। আগামী ম্যাচেও এই জয়ের ধারা অব্যাহত রাখার লক্ষ্য নিয়ে মাঠে নামবে টাইগাররা।</p>
    `,
  ...
  },
  {
    ...
    category: 'প্রযুক্তি',
    content: `
        <p>বহুল প্রতীক্ষিত 5G প্রযুক্তি অবশেষে বাংলাদেশে চালু হতে যাচ্ছে। প্রাথমিকভাবে প্রধান শহরগুলোতে এই সেবা পাওয়া যাবে এবং পর্যায়ক্রমে সারা দেশে বিস্তার লাভ করবে।</p>
        <p>এই প্রযুক্তির মাধ্যমে ইন্টারনেট গতি বহুগুণ বাড়বে, যা ডিজিটাল সেবা, শিক্ষা, এবং স্বাস্থ্যখাতে বৈপ্লবিক পরিবর্তন আনবে বলে আশা করা হচ্ছে। বিশেষজ্ঞরা বলছেন, এটি দেশের অর্থনৈতিক উন্নয়নেও বড় ভূমিকা রাখবে।</p>
    `,
  ...
  },
  {
    ...
    category: 'অর্থনীতি',
    content: `
        <p>গত কয়েক সপ্তাহ ধরে ডলারের বাজারে持续 অস্থিরতা লক্ষ্য করা যাচ্ছে। টাকার বিপরীতে ডলারের দাম বেড়ে যাওয়ায় আমদানি খরচ বাড়ছে, যার প্রভাব পড়ছে সাধারণ মানুষের জীবনযাত্রার উপর।</p>
        <p>অর্থনীতিবিদরা বলছেন, এই পরিস্থিতি নিয়ন্ত্রণে দ্রুত পদক্ষেপ নেওয়া প্রয়োজন। সরকার এবং কেন্দ্রীয় ব্যাংক পরিস্থিতি স্থিতিশীল করতে কাজ করে যাচ্ছে বলে জানিয়েছে।</p>
    `,
  ...
  },
  {
    ...
    category: 'রাজনীতি',
    content: `
      <p>বাংলাদেশ জাতীয়তাবাদী দল (বিএনপি) সরকারের উপর চাপ সৃষ্টি করতে নতুন দেশব্যাপী কর্মসূচি ঘোষণা করেছে। দলের মহাসচিব এক সংবাদ সম্মেলনে এই কর্মসূচির বিস্তারিত তুলে ধরেন।</p>
      <p>কর্মসূচির মধ্যে রয়েছে সমাবেশ, বিক্ষোভ মিছিল এবং অন্যান্য গণতান্ত্রিক কার্যক্রম। দলটি বলছে, তাদের দাবি আদায় না হওয়া পর্যন্ত এই আন্দোলন চলবে।</p>
    `,
  ...
  },
  {
    ...
    category: 'বিনোদন',
    content: `
      <p>আসন্ন ঈদুল আজহা উপলক্ষে পাঁচটি নতুন বাংলা চলচ্চিত্র মুক্তি পেতে যাচ্ছে। জনপ্রিয় তারকাদের অভিনয়ে নির্মিত এই সিনেমাগুলো নিয়ে দর্শকদের মধ্যে ব্যাপক আগ্রহ তৈরি হয়েছে।</p>
      <p>চলচ্চিত্রগুলোর মধ্যে রয়েছে অ্যাকশন, রোমান্টিক-كوميدي, এবং সামাজিক ঘরানার গল্প। নির্মাতারা আশা করছেন, এই সিনেমাগুলো ঈদের ছুটিতে দর্শকদের বিনোদনের খোরাক জোগাবে।</p>
    `,
  ...
  },
  {
    ...
    content: `
      <p>মার্কিন মহাকাশ গবেষণা সংস্থা নাসা একটি নতুন, আরও শক্তিশালী স্পেস টেলিস্কোপ উৎক্ষেপণ করেছে। এই টেলিস্কোপটি মহাবিশ্বের অজানা রহস্য উন্মোচনে সাহায্য করবে বলে আশা করা হচ্ছে।</p>
      <p>এটি দূরবর্তী গ্যালাক্সি এবং এক্সোপ্ল্যানেটের ছবি তুলবে, যা বিজ্ঞানীদের মহাবিশ্বের উৎপত্তি ও গঠন সম্পর্কে নতুন তথ্য দেবে। বিশ্বজুড়ে জ্যোতির্বিজ্ঞানীরা এই মিশনের ফলাফলের জন্য অধীর আগ্রহে অপেক্ষা করছেন।</p>
    `,
  ...
  },
  {
    ...
    category: 'মতামত',
    content: `
      <p>ঢাকা শহরের যানজট একটি নিত্যদিনের সমস্যা। এই সমস্যা সমাধানে শুধু সরকারের উপর নির্ভর না করে নাগরিকদেরও দায়িত্ব রয়েছে। ব্যক্তিগত গাড়ির ব্যবহার কমানো, পাবলিক ট্রান্সপোর্ট ব্যবহারে উৎসাহিত হওয়া এবং ট্রাফিক আইন মেনে চলা অত্যন্ত জরুরি।</p>
      <p>সমন্বিত পরিকল্পনা এবং জনসচেতনতা ছাড়া এই ভয়াবহ সমস্যা থেকে মুক্তি পাওয়া কঠিন। আমাদের সবাইকে একসঙ্গে কাজ করতে হবে একটি যানজটমুক্ত শহর গড়ার জন্য।</p>
    `,
  ...
  },
  {
    ...
    category: 'স্বাস্থ্য',
    content: `
      <p>বর্ষা মৌসুম শুরু হওয়ার সাথে সাথে ডেঙ্গুর প্রকোপ বাড়তে শুরু করেছে। এডিস মশার বংশবিস্তার রোধ করতে வீടിന്റെ চারপাশ পরিষ্কার রাখা এবং জমে থাকা পানি নিষ্কাশন করা অত্যন্ত গুরুত্বপূর্ণ।</p>
      <p>স্বাস্থ্য বিশেষজ্ঞরা বলছেন, জ্বর হলেই চিকিৎসকের পরামর্শ নেওয়া উচিত। ডেঙ্গু প্রতিরোধে ব্যক্তিগত সতর্কতার পাশাপাশি সামাজিক সচেতনতা গড়ে তোলা অপরিহার্য।</p>
    `,
  ...
  },
   {
    ...
    category: 'শিক্ষা',
    content: `
      <p>সরকার নতুন জাতীয় শিক্ষানীতি প্রণয়ন করতে যাচ্ছে, যেখানে মুখস্থবিদ্যার পরিবর্তে সমস্যা সমাধান এবং বিশ্লেষণধর্মী শিক্ষার উপর গুরুত্বারোপ করা হবে।</p>
      <p>শিক্ষাবিদরা এই উদ্যোগকে স্বাগত জানিয়েছেন এবং বলছেন যে এটি শিক্ষার্থীদের ভবিষ্যতের জন্য আরও ভালোভাবে প্রস্তুত করবে।</p>
    `,
  ...
  },
  {
    ...
    category: 'পরিবেশ',
    content: `
      <p>সর্বশেষ জরিপে সুন্দরবনে বাঘের সংখ্যা বৃদ্ধি পেয়েছে বলে জানিয়েছে বন বিভাগ। এটি পরিবেশবিদ এবং বন্যপ্রাণী প্রেমীদের জন্য একটি আনন্দের খবর।</p>
      <p>বাঘের সংখ্যা বৃদ্ধিতে সরকারের বিভিন্ন পদক্ষেপ, যেমন চোরাচালান দমন এবং সচেতনতা বৃদ্ধি, গুরুত্বপূর্ণ ভূমিকা রেখেছে বলে মনে করা হচ্ছে।</p>
    `,
  ...
  },
  {
    ...
    content: `
      <p>আসন্ন ২০২৪ সালের জাতীয় নির্বাচনকে সামনে রেখে সারাদেশে রাজনৈতিক উত্তেজনা বাড়ছে। প্রধান দলগুলো তাদের প্রার্থী তালিকা চূড়ান্ত করতে ব্যস্ত এবং নির্বাচনী ইশতেহার তৈরির কাজ চলছে।</p>
      <p>নির্বাচন কমিশন একটি অবাধ, সুষ্ঠু ও নিরপেক্ষ নির্বাচন অনুষ্ঠানের জন্য সব ধরনের প্রস্তুতি গ্রহণ করছে বলে জানিয়েছে। আন্তর্জাতিক পর্যবেক্ষকরাও এই নির্বাচনের দিকে নজর রাখছেন।</p>
    `,
  ...
  },
  {
    ...
    category: 'বিনোদন',
    content: `
        <p>OTT প্ল্যাটফর্মে মুক্তি পেয়েছে নতুন ওয়েব সিরিজ 'রহস্যের জাল'। এতে প্রধান চরিত্রে অভিনয় করে দর্শকদের মন জয় করেছেন জনপ্রিয় অভিনেত্রী সাবিলা নূর।</p>
        <p>থ্রিলারধর্মী এই সিরিজটি মুক্তির প্রথম দিন থেকেই আলোচনার শীর্ষে রয়েছে। সমালোচকরাও তার অভিনয়ের প্রশংসা করেছেন।</p>
    `,
  ...
  },
  {
    ...
    category: 'খেলা',
    content: `
        <p>বাংলাদেশ প্রিমিয়ার লিগের এক গুরুত্বপূর্ণ ম্যাচে মোহামেডানকে ২-১ গোলে হারিয়েছে আবাহনী লিমিটেড। ম্যাচের শেষ মুহূর্তে আবাহনীর ফরোয়ার্ডের করা গোলে জয় নিশ্চিত হয়।</p>
        <p>এই জয়ে পয়েন্ট টেবিলের শীর্ষে উঠে এসেছে আবাহনী। সমর্থকরা ক্লাবের এই পারফরম্যান্সে উচ্ছ্বসিত।</p>
    `,
  ...
  },
  {
    ...
    category: 'রাজনীতি',
    content: `
        <p>নির্বাচন কমিশন ঢাকা উত্তর সিটি কর্পোরেশনের মেয়র পদে উপ-নির্বাচনের তফসিল ঘোষণা করেছে। আগামী মাসে ভোটগ্রহণ অনুষ্ঠিত হবে।</p>
        <p>প্রধান রাজনৈতিক দলগুলো ইতিমধ্যে তাদের সম্ভাব্য প্রার্থীদের নিয়ে আলোচনা শুরু করেছে। নগরবাসী একজন যোগ্য প্রতিনিধি নির্বাচনের অপেক্ষায় রয়েছে।</p>
    `,
  ...
  },
  {
    ...
    category: 'খেলা',
    content: `
      <p>বিশ্বসেরা অলরাউন্ডার সাকিব আল হাসান আন্তর্জাতিক ক্রিকেটে আরও একটি মাইলফলক স্পর্শ করার দ্বারপ্রান্তে। আর মাত্র ৫০ রান করলেই তিনি ১০,০০০ রান এবং ৫০০ উইকেটের ডাবল অর্জনকারী তৃতীয় ক্রিকেটার হবেন।</p>
      <p>ভক্তরা তার এই অর্জনের জন্য অধীর আগ্রহে অপেক্ষা করছে। আগামী সিরিজেই তিনি এই রেকর্ড গড়তে পারবেন বলে আশা করা হচ্ছে।</p>
    `,
  ...
  },
  {
    ...
    category: 'বিনোদন',
    content: `
      <p>ঢালিউড সুপারস্টার শাকিব খানের নতুন ছবি 'অগ্নিপথ'-এর শুটিং শুরু হয়েছে। ছবিটি পরিচালনা করছেন জনপ্রিয় পরিচালক রায়হান রাফি।</p>
      <p>ছবিটিতে শাকিবের বিপরীতে দেখা যাবে নবাগতা এক নায়িকাকে। অ্যাকশন-থ্রিলার ঘরানার এই সিনেমাটি আগামী বছর মুক্তি পাওয়ার কথা রয়েছে।</p>
    `,
  ...
  },
  {
    ...
    category: 'রাজনীতি',
    content: `
      <p>জাতীয় সংসদের বাজেট অধিবেশন শুরু হয়েছে। অধিবেশনের প্রথম দিনে বেশ কয়েকটি গুরুত্বপূর্ণ বিল উত্থাপন করা হয়েছে।</p>
      <p>বিরোধী দল বিভিন্ন ইস্যুতে সরকারের সমালোচনা করেছে এবং জনগণের স্বার্থে কাজ করার আহ্বান জানিয়েছে। অধিবেশন চলবে আগামী মাস পর্যন্ত।</p>
    `,
  ...
  },
  {
    ...
    category: 'প্রযুক্তি',
    content: `
      <p>সরকারের আইসিটি বিভাগ মেধাবী শিক্ষার্থীদের জন্য 'এক শিক্ষার্থী, এক ল্যাপটপ' প্রকল্পের দ্বিতীয় পর্যায় শুরু করেছে। এর আওতায় দেশের বিভিন্ন বিশ্ববিদ্যালয়ের শিক্ষার্থীদের মাঝে বিনামূল্যে ল্যাপটপ বিতরণ করা হবে।</p>
      <p>ডিজিটাল বাংলাদেশ গড়ার লক্ষ্যে এই উদ্যোগ নেওয়া হয়েছে বলে জানিয়েছে কর্তৃপক্ষ। এটি শিক্ষার্থীদের গবেষণা এবং অনলাইন শিক্ষায় সহায়তা করবে।</p>
    `,
  ...
  },
  {
    ...
    category: 'জাতীয়',
    content: `
      <p>বাংলাদেশের স্বপ্নের পদ্মা সেতুর উদ্বোধনের এক বছর পূর্তি উপলক্ষে দেশব্যাপী আনন্দ ও উৎসবের আমেজ। সেতুটি দেশের দক্ষিণাঞ্চলের অর্থনীতিতে বৈপ্লবিক পরিবর্তন এনেছে।</p>
      <p>বিশেষজ্ঞরা বলছেন, এই সেতুর ফলে জিডিপি প্রবৃদ্ধিতে ইতিবাচক প্রভাব পড়েছে এবং নতুন নতুন শিল্প-কারখানা গড়ে উঠছে।</p>
    `,
  ...
  },
  {
    ...
    category: 'জাতীয়',
    content: `
      <p>ঢাকার যানজট নিরসনে মেট্রোরেল এক যুগান্তকারী পদক্ষেপ। চালু হওয়ার পর থেকে মেট্রোরেল ব্যবহারে জনগণের আগ্রহ ক্রমাগত বাড়ছে। এটি সময় এবং অর্থ উভয়ই সাশ্রয় করছে।</p>
      <p>কর্তৃপক্ষ বলছে, সম্পূর্ণ রুট চালু হলে এটি ঢাকার গণপরিবহন ব্যবস্থায় আরও বড় ইতিবাচক পরিবর্তন আনবে।</p>
    `,
  ...
  },
  {
    ...
    content: `
      <p>রমজান মাস মুসলিমদের জন্য অত্যন্ত পবিত্র একটি মাস। এই মাসে সিয়াম সাধনার মাধ্যমে আত্মশুদ্ধি ও আল্লাহর নৈকট্য লাভের চেষ্টা করা হয়।</p>
      <p>রমজানের মূল উদ্দেশ্য হলো ধৈর্য, সংযম এবং সহানুভূতির শিক্ষা লাভ করা। এই মাসে ইবাদতের মাধ্যমে মুসলিমরা তাদের আধ্যাত্মিক উন্নতি সাধন করেন।</p>
    `,
  ...
  },
  {
    ...
    category: 'ইসলামী-জীবন',
    content: `
      <p>ইসলামের পাঁচটি স্তম্ভের মধ্যে যাকাত অন্যতম। এটি ধনীদের সম্পদে গরীবের অধিকার নিশ্চিত করে এবং সমাজে অর্থনৈতিক ভারসাম্য রক্ষা করে।</p>
      <p>সঠিকভাবে যাকাত আদায় করলে দারিদ্র্য বিমোচন এবং সামাজিক সম্প্রীতি বৃদ্ধি পায়। তাই каждому সামর্থ্যবান মুসলিমের উচিত সঠিকভাবে যাকাত প্রদান করা।</p>
    `,
  ...
  },
  {
    ...
    category: 'তথ্য-যাচাই',
    content: `
      <p>সম্প্রতি সামাজিক যোগাযোগ মাধ্যমে একটি খবর ভাইরাল হয়েছে যেখানে দাবি করা হচ্ছে একজন বাংলাদেশী নাগরিক চাঁদে এক একর জমি কিনেছেন। আমাদের অনুসন্ধানে দেখা গেছে এই দাবিটি সম্পূর্ণ ভুয়া।</p>
      <p>চাঁদে জমি কেনা-বেচার কোনো আন্তর্জাতিক আইন বা স্বীকৃতি নেই। 'লুনার রেজিস্ট্রি' নামক কিছু ওয়েবসাইট থাকলেও সেগুলো কোনো দেশের সরকার বা আন্তর্জাতিক সংস্থা দ্বারা স্বীকৃত নয়। এগুলো মূলত প্রতীকী এবং বিনোদনমূলক। তাই, চাঁদে জমি কেনার খবরটি সত্য নয়।</p>
    `,
  ...
  },
  {
    ...
    category: 'তথ্য-যাচাই',
    content: `
      <p>একটি প্রচলিত ধারণা হলো আনারসের সাথে দুধ খেলে বিষক্রিয়া হয়ে মানুষের মৃত্যু হতে পারে। আমাদের অনুসন্ধানে এবং চিকিৎসা বিজ্ঞানীদের মতে, এই ধারণাটি একটি সম্পূর্ণ গুজব।</p>
      <p>আনারস এবং দুধ একসাথে খেলে হজমে সমস্যা হতে পারে, কারণ আনারসে থাকা ব্রোমেলিন নামক এনজাইম দুধের প্রোটিন ভেঙে দেয়। তবে এটি কোনোভাবেই বিষাক্ত বা প্রাণঘাতী নয়। অতিরিক্ত খেলে পেট ব্যথা বা ডায়রিয়া হতে পারে, কিন্তু মৃত্যুঝুঁকি নেই।</p>
    `,
...
const pages: Page[] = [
    {
        ...
        slug: 'about-us',
        content: `
            <p>বার্তা নাও একটি স্বাধীন অনলাইন নিউজ পোর্টাল। আমরা পাঠকের কাছে বস্তুনিষ্ঠ, নির্ভুল এবং সর্বশেষ সংবাদ পৌঁছে দিতে প্রতিশ্রুতিবদ্ধ। আমাদের লক্ষ্য হলো তথ্যের অবাধ প্রবাহ নিশ্চিত করা এবং গণতন্ত্রকে শক্তিশালী করা।</p>
            <p>আমাদের একদল অভিজ্ঞ এবং নিবেদিতপ্রাণ সাংবাদিক রয়েছেন যারা মাঠ থেকে খবর সংগ্রহ করে এবং সেগুলোকে আপনাদের সামনে তুলে ধরে। আমরা রাজনীতি, অর্থনীতি, খেলা, বিনোদন, প্রযুক্তি এবং আরও অনেক বিষয়ে খবর পরিবেশন করি।</p>
        `,
    ...
    },
    {
        ...
        slug: 'contact-us',
        content: `
            <p>আমাদের সাথে যোগাযোগ করার জন্য ধন্যবাদ। আপনার যেকোনো প্রশ্ন, মতামত বা অভিযোগের জন্য আমরা সর্বদা প্রস্তুত।</p>
            <ul>
                <li><strong>ইমেইল:</strong> contact@bartanow.com</li>
                <li><strong>ফোন:</strong> +৮৮০ ১২৩৪ ৫৬৭৮৯০</li>
                <li><strong>ঠিকানা:</strong> ১২৩ নিউজ স্ট্রিট, ঢাকা, বাংলাদেশ</li>
            </ul>
        `,
        publishedAt: '2024-01-01T10:00:00Z',
