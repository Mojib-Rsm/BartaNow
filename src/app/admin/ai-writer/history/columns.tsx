...
import { ArrowUpDown, MoreHorizontal, Trash2, Clock, Bot } from "lucide-react"
...
export const columns: ColumnDef<Article>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const formatted = format(date, "d MMMM, yyyy", { locale: bn });
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/${article.category.replace(/\s+/g, '-')}/${article.slug}`} target="_blank">আর্টিকেল দেখুন</Link>
            </DropdownMenuItem>
