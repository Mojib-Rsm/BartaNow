    ...
    <div className="container mx-auto py-10 space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>সাইটের নাম, লোগো এবং পরিচিতি পরিবর্তন করুন।</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>হোমপেজের জন্য মেটা টাইটেল এবং ডেসক্রিপশন সেট করুন।</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>আপনার সোশ্যাল মিডিয়া পেজের লিংকগুলো যোগ করুন।</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
      ...
      <Card className="border-destructive">
        <CardHeader>
          ...
          <CardDescription>
            এটি চালু করলে সাধারণ ব্যবহারকারীরা আপনার সাইট দেখতে পারবেন না। শুধুমাত্র অ্যাডমিন লগইন করতে পারবেন।
          </CardDescription>
        </CardHeader>
        <CardContent>
